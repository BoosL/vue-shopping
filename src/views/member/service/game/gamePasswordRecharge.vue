<template>
    <div id="gamePasswordRecharge">
        ...
        <ul class="account" style="margin-bottom:170px;margin-top:15px">
            <li> <span>手机号码</span> <input type="tel" name="" placeholder="接受卡密手机号(选填)"></li>
        </ul>
        <div class="m-footer">
...
export default{
    ...
    methods:{
        selectStyle(e,money){
            var infoA = document.getElementById("gamePasswordRecharge").getElementsByClassName("info");
