<template>
    <div id="trainRefundApplication"  :class="'trainRefundApplication'+$store.state.service.lang">
...
<script>
import  trainRefundApplication_controller from './trainRefundApplication_controller';
export default trainRefundApplication_controller;	
</script>

<style lang="scss" rel="stylesheet/scss" scoped>

.trainRefundApplicationch{
    /*弹窗样式*/
	.modal{
	    position:fixed;
	    top:0;
    ...
    .m-footer{
        ...
        a{color: #333;}
        div{width:50%;float: left;height: 45px;-webkit-box-sizing: border-box;
