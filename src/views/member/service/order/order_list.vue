...
.contes{position: fixed;bottom: 0;width: 100%;height: 35px;background: #FFF;line-height: 35px;border-top: #e2e2e2 solid 1px;text-align: right;
	button{border: solid 1px #f15353;background: #FFF;border-radius: 14px;margin-right: 5px;color: #f15353;}
}
.loadNomore img {
	width: 20%;
}
