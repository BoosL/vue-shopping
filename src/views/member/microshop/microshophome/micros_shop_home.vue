	...
	<div id="microShop_main">
		...
		<div class="footer">
			<ul>
				...
				<router-link :to="fun.getUrl('microShop_apply')" v-if="!is_micro_shop">
					<li>
				...
				<router-link :to="fun.getUrl('microShop_ShopKeeperCenter')" v-if="is_micro_shop">
					<li>
						<div class="openMyShop">
							<span>店主</span>
							<p>中心</p>
...
<script>
import micros_shop_home_controller from './micros_shop_home_controller';
export default micros_shop_home_controller;
</script>
