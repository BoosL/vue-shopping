<template>
    <div id="love_changein">
    	<c-title :hide="false" text='转账-转入详情' ></c-title>
    	<div style="height: 100px;"></div>
    	<p>转账-转入</p>
    	<p id="money">+100元</p>
    	<p id="dingjing">激活</p>
    	<div class="tbs">
    		<div class="left">转入会员</div>
    		<div class="right">李宁</div>
    		<div class="left">转入会员ID</div>
    		<div class="right">009</div>
    		<div class="left">转入爱心值</div>
    		<div class="right">20.00元</div>	    		
    	</div>
    	<div class="tbs">
    		<div class="left">转入时间</div>
