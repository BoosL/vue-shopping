...
const routes = [
  ...
  { path: '/member/order/cash/:order_pay_id', component: OrderCash, name: 'orderCash', meta: { title: '门店支付', foot: true } },
...
{path: '/train_pay/:para', component: TrainPay, name: 'train_pay',meta: { title: '火车票支付', foot:true }},
  ...
  { path: '/o2o/storeApply', component: StoreApply, name: 'storeApply', meta: { title: '', foot: true } },
  ...
  { path: '/member/courselevel', component: CourseMemberUpdate, name: 'CourseMemberUpdate', meta: { title: '升级会员' , foot: true} },
